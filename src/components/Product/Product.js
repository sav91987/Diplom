            ...
            >
                <SwiperSlide>
                    <img
                        ...
                        alt={product[0].imgAlt + "_1"}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <img
                        className="swiper__img"
                        src={"/" + product[0].imgUrl1}
                        alt={product[0].imgAlt + "_2"}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <img
                        className="swiper__img"
                        src={"/" + product[0].imgUrl2}
                        alt={product[0].imgAlt + "_3"}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <img
                        className="swiper__img"
                        src={"/" + product[0].imgUrl3}
                        alt={product[0].imgAlt + "_4"}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <img
                        className="swiper__img"
                        src={"/" + product[0].imgUrl4}
                        alt={product[0].imgAlt + "_5"}
                    />
                </SwiperSlide>
            </Swiper>

            <section className="producDiscription container">
                <h2 className="producDiscription__type">
                    {product[0].category}
                </h2>

                <h2 className="producDiscription__name">
                    {product[0].saleCardName}
                </h2>
                <p className="producDiscription__discription">
